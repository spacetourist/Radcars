...
const TRACKS = [
  {
    ...
    race: '67-neon-track-clear-race',
    raceFar: '67b-neon-track-clear-race-far',
    gridFar: '67c-neon-track-clear-grid-far'
  },
  {
    index: 1, id: 'gridlock',
    race: '68-gridlock-track-clear-race',
    raceFar: '68b-gridlock-track-clear-race-far',
    gridFar: '68c-gridlock-track-clear-grid-far'
  }
];
...
for (const t of TRACKS) {
  ...
  await setZoomShot(page, 1.35, true);
